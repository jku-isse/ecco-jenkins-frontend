...
/**
 * Defines the transferable objects for coordinates.
 *
...
public class CoordinateDTO {
    ...
    public CoordinateDTO(
            @JsonProperty(value = "longitude", required = true) @JsonAlias({"Longitude", "lon"}) double longitude,
    ...
    public boolean equals(Object other) {
        ...
        final var rhs = (CoordinateDTO) other;
